...
class Solution {
  List<bool> kidsWCandies(List<int> candies, int extraCandies) {
    //array of results type bool tru/false
    List<bool> result = [];
    int maxCandies = candies.reduce((a, b) => a > b ? a : b);
    for (int candy in candies) {
      //check if their candies plus the extra candies are greater than or equal to maxCandies
